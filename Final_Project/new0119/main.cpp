...
void Find_kcore(int n);
void BronKerbosch2(set<int> R, set<int> P, set<int> X);
void find_BronKerbosch3(int n);
...
int main(int argc, char *argv[])
{
    ...
    Find_kcore(num_vertex);

    find_BronKerbosch3(num_vertex);
...
void Find_kcore(int num_vertex)
{
    int min = INT_MAX;
    int new_min = INT_MAX;
...
void find_BronKerbosch3(int num_vertex)
{
    set<int> R;
    set<int> P;
    set<int> X;
